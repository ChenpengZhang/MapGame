 ...
 * @param {boolean} [cfg.showTowerReset]  是否显示"从第 1 层重来"
...
export function showResultOverlay(cfg) {
  ...
  if (cfg.message != null) setText('result-message', cfg.message);
  if (cfg.detail != null) setText('result-times', cfg.detail);
  ...
  if (cfg.showTowerReset != null) toggleHidden('result-tower-reset', !cfg.showTowerReset);
